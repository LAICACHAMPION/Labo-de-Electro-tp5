...
\def\input@path{{../../}} 
\makeatother
\input{labo_tp5_preamble.tex}

\begin{document}

\newgeometry{}

\input{labo_tp5_caratula.tex}
\tableofcontents
\newpage
